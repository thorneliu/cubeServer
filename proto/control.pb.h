...
namespace google {
namespace protobuf {
template<> ::rec::mcube::HttpRequest* Arena::CreateMaybeMessage<::rec::mcube::HttpRequest>(Arena*);
template<> ::rec::mcube::HttpResponse* Arena::CreateMaybeMessage<::rec::mcube::HttpResponse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace rec {
namespace mcube {
